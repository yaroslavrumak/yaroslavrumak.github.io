...
//  this.supportsTransforms = Modernizr.csstransforms3d;
  ...
  this.siteYAddSpec = 0;
  this.siteScale = 1;
  this.sitesArray = ["GRAPHIC DESIGN", "COPPYWRITIGN / PROOFING", "BRAND / STRATEGY", "USER INTERFACE / EXPERIENCE", "VIDEO PRODUCTION", "PRESENTATION", "APP DESIGN", "PACKAGING", "ANIMATION", "CORPORATE IDENTITY", "WEB DESIGN", "VISUAL BARAND IDENTITY"];
...
function handleHashChangeInit() {
  ...
  switch (idSite) {
    ...
    case 5:
      ...
      break;
    case 6:
      if (siteVersion != 1) newPosition = 8806;
//      else newPosition = 7230 + 350 + 1500 + 300;
      BMSite.currentScrollY = newPosition * BMSite.siteScale;
      BMSite.currentSite = 6;
      break;
    case 7:
      if (siteVersion != 1) newPosition = 10306;
//      else newPosition = 7230 + 350 + 1500 + 300;
      BMSite.currentScrollY = newPosition * BMSite.siteScale;
      BMSite.currentSite = 7;
      break;
    case 8:
      if (siteVersion != 1) newPosition = 11806;
//      else newPosition = 7230 + 350 + 1500 + 300;
      BMSite.currentScrollY = newPosition * BMSite.siteScale;
      BMSite.currentSite = 8;
      break;
    case 9:
      if (siteVersion != 1) newPosition = 13306;
//      else newPosition = 7230 + 350 + 1500 + 300;
      BMSite.currentScrollY = newPosition * BMSite.siteScale;
      BMSite.currentSite = 9;
      break;
    case 10:
      if (siteVersion != 1) newPosition = 14806;
//      else newPosition = 7230 + 350 + 1500 + 300;
      BMSite.currentScrollY = newPosition * BMSite.siteScale;
      BMSite.currentSite = 10;
      break;
    case 11:
      if (siteVersion != 1) newPosition = 16306;
//      else newPosition = 7230 + 350 + 1500 + 300;
      BMSite.currentScrollY = newPosition * BMSite.siteScale;
      BMSite.currentSite = 11;
      break;
