...
$(document).ready(function () {
  ...
  $(document).on('click', '.menu-button', function () {
    if ($(document).scrollTop() > ($('.grid-container').offset().top - $(window).height())) {
      if (menuStatus == 0) {
        ...
        tl.to($('.st0, .menu-button__title'), .5, {
//        tl.to($('.st0'), .5, {
          ease: Power3.easeOut,
          fill: "#000"
        }, 0)
...
//        tl.to($('.st0'), .5, {
      ...
      if (menuStatus == 0) {
        ...
        tl.to($('.st0, .menu-button__title').not('.a-side__logo .st0'), .5, {
          ease: Power3.easeOut,
          fill: "#fff",
          color: '#fff'
        }, 0)
...
$(document).ready(function () {
  ...
  var scene = new ScrollMagic.Scene({
    ...
    .setTween('.st0, .menu-button__arrow', {
  ...
  var scene = new ScrollMagic.Scene({
    ...
    .setTween('.b-side__nav a, .menu-button__title', {
...
$(document).ready(function(){
    $(".history").click(function(){
        $(".history-container").addClass("active-history");
    });
    $(".history-container").click(function(){
    $(".history-container").removeClass("active-history");
    });
});
